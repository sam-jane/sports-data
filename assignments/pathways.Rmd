...
list.files()
list.files("data")
file.exists("data/coaching_histories.json")
Sys.getenv("HOME")                     # see your user path
list.files("~/Downloads")              # make sure you see 'sports-data-class'
list.files("~/Downloads/sports-data-class")   # make sure you see 'sports-data' or the JSON
list.files("~/Downloads/sports-data-class/sports-data")  # should show 'coaching_histories.json'
```
...
coaching_data <- fromJSON(
  "~/Downloads/sports-data-class/sports-data/coaching_histories.json",
  flatten = FALSE
)
