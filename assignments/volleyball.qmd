...
comparison_data <- bind_rows(
  team_totals |> mutate(group = "All D-1 Teams"),
...
##Big Ten teams are much stronger thant the rest of the country when it comes to the average benchmark for hit rates. The conference's average is signifcantly higher than the remaining teams average and would fall in the 75% percentile for all D1 teams. This suggests that the Big Ten is one of the strongest conferences in the country and it's average to below-average teams actually rate among the top of the country.

2. How does the sample size difference between these two groups affect your confidence in the results?
##I think there's a large enough sample size, considering we took all D1 teams. One thing we could look at to compare them to the rest of the Power Five conferncees would give us a stronger idea of how the conference stacks up not to the rest of the country, but to conferences with similar resources and prestige.
...
##The Big Ten's average hitting percentage is nearly .2 points higher than the average Division One mark.
...
##There's no relation between teams under or outperforming their expectations  
...
##I see that teams are generally even when it comes to their offensive and defensive performances on hit vs defensive hitting percentage. 
...
##There's not a strong correlation between defensive hitting percentage and defensive quality. Therefore, we shouldn't be entirely sure that teams are going to win games based of their defensive hitting percentage.
...
##I think I would look at if team's hit rate actually leads to wins?
