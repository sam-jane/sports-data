...
#Julian Reese and his true shooting percent is 0.599%
...
matches_2024 |>
  ...
  group_by(team) |>
  summarise(
    total_attempts = sum(sh_att, na.rm = TRUE),
    total_on_goal = sum(so_g, na.rm = TRUE),
    percent = (total_on_goal / total_attempts) * 100
  )
```

**ANSWER** How do the two years compare?
#Maryland's shooting almost 10% better this year than they did in 2024.