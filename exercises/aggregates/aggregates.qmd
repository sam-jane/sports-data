...
```
**Answer** It created a big data set of NBA players
...
**Answer** This splits up the position groupings
...
**Answer** This shows the position groupings in the NBA in a descending order to how many players are in the NBA by position
...
Tbe fact that small forwards play a lower aggregate average but have the highest max of any position. That's a statistical contrast is a very different than what I expected.
